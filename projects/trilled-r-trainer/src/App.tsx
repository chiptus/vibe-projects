...
function parseImportedPreset(json: string): Preset | null {
  try {
...
export default function App() {
  ...
  const updateExercises = (newExercises: Exercise[]) => library.updateExercises(newExercises);
  ...
  const handleDeleteExercise = (index: number) => {
    ...
    updateExercises(newExercises);
    timer.clampIndex(newExercises.length);
  };
  ...
  const handleImport = (key: string, json: string) => {
